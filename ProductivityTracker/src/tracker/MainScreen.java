...
public class MainScreen {
	 ...
	 */
	 void initialize() {
		...
		btnNewButton_1.setBounds(0, 176, 114, 28);
		...
		btnNewButton_2.setBounds(0, 108, 114, 28);
		...
		txtProductivityTracker.setFont(new Font("Times New Roman", Font.BOLD, 15));
		txtProductivityTracker.setText("Productivity Tracker Group 60");
		txtProductivityTracker.setBounds(180, 10, 500, 19);
