...
import tracker.SurajClasses.BITSProductivityTracker.Course;
...
public class AddTests {
    ...
    private void initialize() {
        ...
        j2 = new JLabel("Enter Date");
        j3 = new JLabel("Enter Syllabus");
        start = new JSpinner();
        end = new JSpinner();
        marks = new JSpinner();
        textField = new JTextField("dd-mm-yyyy");
        syllabus = new JTextField("Add topics");
